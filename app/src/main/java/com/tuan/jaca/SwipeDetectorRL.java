...
//Borrowed from Professor Witchel
//Code adapted from https://stackoverflow.com/questions/17520750/list-view-item-swipe-left-and-swipe-right
public class SwipeDetectorRL implements RecyclerView.OnItemTouchListener {
    @Override
    ...
    private static final String logTag = "SwipeDetectorRL";
